...
import com.bridgelabz.user_service.Util.EmailSenderService;
import com.bridgelabz.user_service.Util.TokenUtility;
...
import com.bridgelabz.user_service.exception.BookStoreException;
...
public class UserService implements IUserService {
    ...
    public String addUser(UserDTO userDTO) {
        ...
        mailService.sendEmail(newUser.getEmail(), "Test Email", "Registered SuccessFully, hii: "
                ...
                + "http://localhost:8085/user/verify/" + token);
        return token;
    }
    ...
    public Object getUserByToken(String token) {
        ...
        if (getUser.isPresent()) {
            mailService.sendEmail("syedmahammadSameer999@gmail.com", "Test Email", "Get your data with this token, hii: "
                    ...
                    + "http://localhost:8085/user/getAll/" + token);
            return getUser;
